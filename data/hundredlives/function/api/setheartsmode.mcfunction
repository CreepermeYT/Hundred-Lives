...
execute if score mh hdelay matches 1 run tellraw @s [{"text":"Hearts mode set to"},{"text":" remain with the same ","bold":true,"italic":true,"color":"gray"},{"text":"hearts","bold":true,"italic":true,"color":"red"},{"text":" in the last 10 lives"}]
